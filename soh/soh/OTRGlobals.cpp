...
void OTRGlobals::Initialize() {
    ...
    std::string logFilePath;
    {
        ...
        const std::string baseName = Ship::Context::GetRawInstance()->GetName();  // "Ship of Harkinian"
...
extern "C" void OTRControllerCallback(uint8_t rumble) {
    ...
    if (controllerConfigWindow == nullptr) {
        controllerConfigWindow = std::dynamic_pointer_cast<SohInputEditorWindow>(
            Ship::Context::GetRawInstance()->GetWindow()->GetGui()->GetGuiWindow("Controller Configuration"));
